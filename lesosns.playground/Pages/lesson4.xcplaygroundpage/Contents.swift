...
let variable: EmptyClosure = { print("EmptyClosure") }
...
var names = ["andrew", "alex", "andrew", "alex", "andrew", "alex", "andrew", "alex"]

var sortedNames0 = names.sorted { s1, s2 in
    s1 > s2
}

var sortedNames1 = names.sorted(by: { (s1: String, s2: String) -> Bool in
    return s1 > s2
})
